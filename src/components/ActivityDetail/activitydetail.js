        ...
        <div>
            ...
            <div className={styles.contentleft}>
                ...
                <div className={styles.wrapper}>
                    <Link to={activity.title === 'Raya-Yoga' ? ROUTES.yogadetail : activity.title === 'Stargazing' ? ROUTES.finland : activity.title === 'Buon Appetito' ? ROUTES.pizzaconfigurator : ROUTES.activities} className={styles.button_left}>Begin de activiteit</Link>
