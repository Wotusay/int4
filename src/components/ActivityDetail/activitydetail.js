        ...
        <div>
            ...
            <div className={styles.contentleft}>
                ...
                <div className={styles.wrapper}>
                    ...
                    <Link to={ROUTES.home} className={styles.button_right}> <svg className={styles.icon} width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
