...
const Boxes = () => {
    ...
    return useObserver(() => (
        ...
        {id === 'adventure-box' ? <> <img className={styles.leave1} alt="prop1" src="/assets/adventurebox/leaves-bottom.png" />  <img className={styles.leave2}  alt="prop2" src="/assets/adventurebox/leaves-top.png" />  </>: id === 'romantic-box' ? <> <img className={styles.leave1} alt="prop1" src="/assets/left.png" />  <img className={styles.top}  alt="top" src="/assets/toop.png" /> <img className={styles.right}  alt="right" src="/assets/right.png" />  </> : id === 'tropic-box' ? <> <img className={styles.leave2}  alt="prop2" src="/assets/tropicbox/top.png" /> <img className={styles.leave1}  alt="prop1" src="/assets/tropicbox/bottom.png" />  </>: <Redirect to={ROUTES.boxes.to + '/adventure-box'}  /> }
        </MediaQuery>
